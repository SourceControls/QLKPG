...
import com.raven.event.EventCallBack;
import com.raven.event.EventTextField;
...
public class TextFieldAnimation extends JTextField {
    ...
    private String hintText = "Tìm khách hàng...";
...
//        System.out.println(getClass().getResource("/com/raven/icon/nv.png"));
        iconSearch = new ImageIcon(getClass().getResource("/com/raven/icon/search2.png"));
...
//        g2.fillOval(width - height + 3, marginButton, buttonSize, buttonSize);
        ...
        int marginImage = 5;
        int imageSize = buttonSize - marginImage * 2 + 10;
        Image image;
        if (show) {
        ...
        g2.drawImage(image, width - height + marginImage + 3 - 5, marginButton + marginImage - 5, imageSize, imageSize, null);
        g2.dispose();
    }
