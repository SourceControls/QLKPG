...
//        System.out.println("KM" + tiLeKM);
//        System.out.println("Thue" + tiLeThue);
//        System.out.println("Tong Tien" + (1 - thanhTien/(giaGoc*(1+tiLeThue))));
...
=======
        if (csdlDK.insertPDK(maPDK, ngayDK, tongTien, ghiChu, maKH, FrmMain.maNV, maDV, thue, cbTiLeKM.getSelectedItem()));
>>>>>>> Stashed changes
        {
            if (rbtnDaThanhToan.isSelected()) {
                ...
                if (FrmThanhToan.csdlTT.insertPTT(vec)) {
                    JOptionPane.showMessageDialog(this, "Lập Phiếu Thanh Toán Thành Công");
                    DungChung.fillTable(com.raven.form.Form2.dtblPDK, DKDV.csdlDKDV.selectAllPDK());
                } else {
                    JOptionPane.showMessageDialog(this, "Lập Phiếu Thanh Toán Thất Bại");
                }
                this.setVisible(false);
            }
            DungChung.fillTable(com.raven.form.Form2.dtblPDK, DKDV.csdlDKDV.selectAllPDK());
